...
(1,'pbkdf2_sha256$720000$7Bw5HaZnN8V9X7lROjVI5f$2ROtS/vjX5wm2Rd7+FZZSNcFcCu+zkYDiarpuYOYXPg=','2024-05-17 08:12:09.284428',1,'admin','','','admin@gmail.com',1,1,'2024-05-14 07:00:20.301079');
...
('ucfh14c1ei59b5mstybq6i6yjspkd96o','.eJxVjrkOwjAQRP_FNbLsJddS0ucbrD28JBAlUo4K8e8kUgpo5808zdsl2tYubUueU6_u5qK7_GZM8srjAfRJ42PyMo3r3LM_Kv6ki28nzcP97P4JOlq6fW211NSEiGLUWEZgqU0taGAoDaG8RmxAjCtlIIsYKpYCA1KBrBB26XD8g88X1q06qw:1s7shF:ax3pYAsFOIXZGzdPjmxfssNPAMdA9T6hwJvRACBc_To','2024-05-31 08:12:09.290430');
...
(49,'2024-05-16','structures are a specific way of organizing data in a specialized format on a computer so that the information can be organized, processed, stored, and retrieved quickly and effectively','3','pending',11,1);
...
(1,'lap is not working ','pending','2024-05-15',1),
(2,'lap is not working ','pending','2024-05-15',1),
...
(3,'MSc Computer Science',2),
(4,'BSc Computer Science',2),
(5,'MSc Statistics',3),
(6,'BSc Statistics',3);
...
(1,'hiii','2024-05-14','2024-05-14',1,'pending'),
(2,'introduction to data structures ','2024-05-15','2024-05-15',1,'started'),
(3,'data structures ','2024-05-15','2024-05-15',1,'pending'),
(4,'dhgg','2024-05-24','2024-05-15',1,'pending');
...
(7,'Explain data structures?','A data structure is a specialized format for organizing, processing, retrieving and storing data.',2,'5'),
...
(11,'what is data structures?','Data structures are a specific way of organizing data in a specialized format on a computer so that the information can be organized, processed, stored, and retrieved quickly and effectively. They are a means of handling information, rendering the data for easy use.The four basic data structure types are linear data structures, tree data structures, hash data structures and graph data structures',3,'5'),
(12,'what is compiler?','compiler is a computer program that helps in translating the computer code from one programming language into another language.',4,'5');
